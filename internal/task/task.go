...
type ReadyTask struct {
	...
	DesignReplanVersion      int      `json:"design_replan_version,omitempty"`
	...
	MergeRetryNotBefore      string   `json:"merge_retry_not_before,omitempty"`
...
func FindReadyTaskForFile(vaultPath, changedFile string) (*ReadyTask, error) {
	...
	rt := &ReadyTask{
		...
		MergeRetryNotBefore:      fm.MergeRetryNotBefore,
