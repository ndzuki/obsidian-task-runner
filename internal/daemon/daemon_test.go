...
func TestWorktreePathFromError(t *testing.T) {
	err := "fatal: 'task/057-web-operation-timeline' is already used by worktree at '/home/user/.otg-worktrees/task057-cifix'"
	if got := worktreePathFromError(err); got != "/home/user/.otg-worktrees/task057-cifix" {
