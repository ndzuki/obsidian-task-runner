...
func TestBuildProjectContext_ReleaseManager(t *testing.T) {
	projectVaultDir := "/home/user/cloud/Vault/Projects/001-release-manager"
	reqPath := "/home/user/cloud/Vault/Projects/001-release-manager/Requirements/REQ-061-install-sdk-quality.md"
