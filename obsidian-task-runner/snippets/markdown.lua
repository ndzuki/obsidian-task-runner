...
return {
  ...
  s('otask', {
    ...
    t({ '', '# 🔵 Gate — 由你批准', 'plan_approved: false', 'auto_approve: true  # 默认自动批准：grilling 后全自动；设 false 恢复人工审计划', 'auto_merge: true', 'merge_approved: false', 'adr_approved: false', 'resume_approved: false', 'close_approved: false', 'pending_req: false' }),
    ...
    t({ '', '# 🟢 高级（按需取消注释）', '# due_date: ""', '# estimated_hours: 0', '# actual_hours: 0', '# component: ""', '# parent: ""', '# reviewer: ""', '# author: ""', '# template: ""', '# off_peak_only: false' }),
    t({ '', '# 时间戳（系统维护）', 'created: ""', 'updated: ""' }),
    t({ '', '# ⚪ 系统维护 — 不要手动改', 'maturity: ""', 'refine_version: 0', 'refine_req_hash: ""', 'refine_retry_count: 0', 'refine_error: ""', 'plan_req_hash: ""', 'plan_version: 0', 'planning_retry_count: 0', 'checkpoint_commit: ""', 'target_branch: ""', 'pr_url: ""', 'completed: ""', 'reopen_count: 0', 'merge_status: ""', 'approved_head: ""', 'merge_retry_count: 0', 'task_schema_version: 1', 'req_refine_count: 0', 'blocked_phase: ""', 'phase_error: ""', 'phase_error_code: ""', 'phase_log: ""', 'auto_resume_pending: false', 'auto_resume_count: 0' }),
